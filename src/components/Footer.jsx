      ...
      <div className="container border border-black  px-6 pt-6">
        ...
        <div className="flex justify-end mb-6">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-full border-2 border-bg text-black leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
              aria-hidden="true"
              focusable="false"
